...
地址：[https://github.com/ThinkiumGroup/web3.js](https://github.com/ThinkiumGroup/web3.js)
...
**thinkium-web3js 项目 test/contract/deploy_test.js 文件有示例**
...
function compileContract(contractContent) {    //合约可能有多个
    const input = {
        language: 'Solidity',
        sources: {
            'test.sol': {
...
### 10.1 部署合约（web3.thk.contract(abi).new({data: code});）

**thinkium-web3js项目 test/contract/deploy_test.js 文件有示例**
...
console.log('contractAddress: ', contractAddress); //返回的为部署后的合约地址
console.log('contractAbi: ', contractAbi);
```

### 10.2 调用合约方法 (web3.thk.contract(abi,contractAddress).at(contractAddress))
...
// 调用合约内的 setNickname 和 getNickname方法
helloWorld.setNickname("world");
sleep(5); // 合约内的修改方法需要等待hash成功后，此处等待5秒，酌情修改等待时长
...
{
    "nodeId":
    "0x5e17128ba224a96d6e84be0c7f899febea26c55c78940610d78a0d22dbd0ab03cc3233491de0b5eb770dbf850b509bd191723df4fc40520bcbab565d46543d6e",
    "version": "V1.0.0",
    "isDataNode": true,
    "dataNodeOf": 0,
